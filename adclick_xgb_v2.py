...
features = list(train.columns.values) #list(set(train.columns) - set(['ID','datetime','click']))
features.remove('ID')
...
output.to_csv(base_output_path+'xgboost-v2-auc-{}.csv'.format(auc_score), index=False)
